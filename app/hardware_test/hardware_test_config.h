...
#define HARDWARE_TEST_GRAY_SENSOR 5
#define HARDWARE_TEST_ENCODER 6
#define HARDWARE_TEST_MOTOR 7
#define HARDWARE_TEST_STEPPER_UART 8

/* Select one hardware test here, then rebuild the project. */
#define HARDWARE_TEST_MODE HARDWARE_TEST_STEPPER_UART

#if (HARDWARE_TEST_MODE < HARDWARE_TEST_NONE) || \
    (HARDWARE_TEST_MODE > HARDWARE_TEST_STEPPER_UART)

...
The tests compile the motor hardware-test sequence and task isolation, real IMU,
INS return logic, VOFA, transparent UART, vision communication,
LED, active-buzzer, key, electromagnet, photoelectric switch, servo, PID, motor backends,
closed-loop motor, encoder decoder, PWM, UART completion state, GPIO, and I2C
sources against small host-side DriverLib stubs. They do not
